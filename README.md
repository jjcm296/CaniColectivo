...
| Update artist profile          | auth          | PUT    | /artists/{id}          | { name*, location*, description, phone, socialMedia:{x,instagram,tiktok,facebook}, specialities: [{name, type}]  } | Updated artist object                                                                           |
